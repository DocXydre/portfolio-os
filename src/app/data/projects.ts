...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'planificateur',
    name: 'Planificateur personnel — emploi du temps automatique',
    folder: 'perso',
    year: '2026',
    role: 'Développeur',
    context: 'Projet personnel — M1 MIAGE',
    stack: ['Python 3.12', 'FastAPI', 'PostgreSQL 16', 'psycopg 3 (sans ORM)', 'APScheduler', 'python-telegram-bot', 'Docker'],
    summary: "Système qui croise mes emplois du temps, en déduit les creux et y place seul les tâches récurrentes (ménage, sport), avec un calendrier et un bot Telegram.",
    description: [
      "Système personnel qui croise mes différents emplois du temps — cours (flux ADE de l'université), shifts au McDonald's, calendriers personnels — pour en déduire mes créneaux libres et y placer automatiquement les tâches récurrentes : ménage, lessives et séances de sport. Il rend deux sorties : un calendrier à afficher sur le téléphone et un bot Telegram pour valider ce qui est fait.",
      "Le parti pris technique fort : les règles métier vivent dans PostgreSQL, pas dans le code. L'API (FastAPI) reste une couche mince qui appelle des fonctions et expose des vues, sans rien décider. Non-chevauchement des cours garanti par une contrainte d'exclusion GiST, calcul des disponibilités par arithmétique de multirange (TSTZRANGE) plutôt que par des boucles, placement et récurrence en PL/pgSQL : la cohérence tient même si un script ou une saisie manuelle contourne l'API.",
      "Le système collecte les flux iCalendar et arbitre les conflits horaires, place les tâches un mois à l'avance en figeant la semaine en cours, gère les absences (partir en week-end gèle le ménage et redistribue la charge à qui reste), interroge l'API SNCF pour proposer des trajets réellement attrapables, et déclenche les lessives d'uniforme selon le nombre de services travaillés. Il tourne en continu sur un serveur perso sous Debian, accessible via Tailscale, avec déploiement automatique à chaque git push.",
      "Projet toujours en cours : je continue de l'ajuster et de l'améliorer, en particulier pour que les tâches ménagères et les séances de sport se placent exactement comme je le souhaite — bon créneau, bonne fréquence et prise en compte correcte des conditions réelles (horaires d'ouverture, trajet compris). Une interface web Angular est également prévue pour remplacer le bot sur les usages qui demandent un écran.",
    ],
    images: [
      'projects/planif-calendrier.webp',
      'projects/planif-bot.webp',
      'projects/planif-trajets.webp',
    ],
    repo: 'https://github.com/DocXydre/Projet_Emploie_du_temps',
    link: undefined,
  },
  {
    id: 'decibulles-bot',
